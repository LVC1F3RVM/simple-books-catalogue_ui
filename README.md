...
## **Task**
The goal of this project is to implement a small web application (without using any external libraries or frameworks) that allows users to search for books by title via a public API (Open Library), view the results, and add their favorite books to a "favorites" list with data persistence.
...
This project uses **Vite** as a module bundler to optimize the code. 
